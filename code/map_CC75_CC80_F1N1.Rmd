...
here::i_am("code/map_CC75_CC80_F1N1.Rmd",
           uuid = "6025f6f1-5e44-4991-b15b-3cbabbd877c7")
library(here)
...
pdat <- filter(pheno, trt != 'isotype') |>
    ...
    separate(mouse_id, into = c(NA, 'suffix'), sep = '-') |>
    rename(mouse_id = suffix) |>
    as.data.frame() |> 
...
plot(out, obj$gmap, lodcolumn = 'complete_responder', ylim = c(0, 10))
